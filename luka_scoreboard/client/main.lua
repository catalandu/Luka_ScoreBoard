...
Citizen.CreateThread(function()
	...
	Citizen.Wait(2000)
	ESX.TriggerServerCallback('luka_scoreboard:getConnectedPlayers', function(connectedPlayers)
...
RegisterNetEvent('luka_scoreboard:updateConnectedPlayers')
AddEventHandler('luka_scoreboard:updateConnectedPlayers', function(connectedPlayers)
	UpdatePlayerTable(connectedPlayers)
end)

RegisterNetEvent('luka_scoreboard:updatePing')
AddEventHandler('luka_scoreboard:updatePing', function(connectedPlayers)
	SendNUIMessage({
		action  = 'updatePing',
...
RegisterNetEvent('luka_scoreboard:toggleID')
AddEventHandler('luka_scoreboard:toggleID', function(state)
	if state then
		idVisable = state
	else
